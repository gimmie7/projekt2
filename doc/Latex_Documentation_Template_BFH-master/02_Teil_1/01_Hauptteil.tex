...
\[Differenz_E = Messung_t1 - Messung_t2 t2\]

Messung_t1 entspricht dabei einer Messung zum Zeitpunkt t1, Messung_t2 einer Messung zum Zeitpunkt t2.
...
Derjenige Verbraucher, dessen Differenz am nächsten bei dieser Differenz liegt, wird als der eventauslösende Verbraucher identifiziert.
