...
\label{sec:teil1_kombinatorik}
Der Ansatz mittels Kombinatorik weist, wie schon im vorherigen Kapitel erwähnt, noch einige Probleme auf und ist für eine präzise Disaggregation somit nicht geeignet. Es wird ein Modell benötigt, welches robust ist, auch wenn die Anzahl der Geräte erhöht wird. Ausserdem sollten auch Multistatusgeräte klassifiziert werden können, wie beispielsweise ein Staubsauger oder eine Waschmaschine. Und auch Geräte mit ähnlichem Verbrauch sollte das Modell erkennen können.
